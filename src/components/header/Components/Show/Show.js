...
function Show() {
    ...
    return (
        <Show>
            <Box>
                <StringBox>
                    <OrganizeString className="organizestring">GRÊMIO</OrganizeString>
                    <OrganizeString className="organizestring">REZENDE</OrganizeString>
                    <OrganizeString className="organizestring">2O21</OrganizeString>
                </StringBox>
                <AddingTask>
                    <Animation></Animation>
                </AddingTask>
